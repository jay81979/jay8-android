...
namespace Managed.Adb.Extensions {
	public static partial class MadbExtensions {
		...
		/// <returns></returns>
		public static Attribute[] GetCustomAttributes<T> ( this Module module ) where T : Attribute {
			return Attribute.GetCustomAttributes ( module, typeof ( T ) );
		}
		...
		/// <returns></returns>
		public static  Attribute[] GetCustomAttributes<T> ( this MemberInfo mi ) where T : Attribute {
			return Attribute.GetCustomAttributes ( mi, typeof ( T ) );
		}
		...
		/// <param name="mi">The mi.</param>
		/// <returns></returns>
		public static  Attribute[] GetCustomAttributes<T> ( this MethodInfo mi ) where T : Attribute {
			return Attribute.GetCustomAttributes ( mi, typeof ( T ) );
		}
		...
		/// <returns></returns>
		public static Attribute[] GetCustomAttributes<T> ( this PropertyInfo pi ) where T : Attribute {
			return Attribute.GetCustomAttributes ( pi, typeof ( T ) );
		}
		...
		/// <param name="pi">The pi.</param>
		/// <returns></returns>
		public static Attribute[] GetCustomAttributes<T> ( this ParameterInfo pi ) where T : Attribute {
			return Attribute.GetCustomAttributes ( pi, typeof ( T ) );
		}
		...
		/// <returns></returns>
		public static Attribute[] GetCustomAttributes<T> ( this FieldInfo fi ) where T : Attribute {
			return Attribute.GetCustomAttributes ( fi, typeof ( T ) );
		}
		/// <summary>
		...
		/// <param name="type">The type.</param>
		/// <returns></returns>
		public static Attribute GetCustomAttribute<T> ( this Type type ) where T : Attribute {
		...
		/// <returns></returns>
		public static Attribute GetCustomAttribute<T> ( this Module module ) where T : Attribute {
		...
		/// <returns></returns>
		public static Attribute GetCustomAttribute<T> ( this MemberInfo mi ) where T : Attribute {
		...
		/// <param name="mi">The type.</param>
		/// <returns></returns>
		public static Attribute GetCustomAttribute<T> ( this MethodInfo mi ) where T : Attribute {
			return GetCustomAttributes<T> ( mi ).FirstOrDefault ( );
		}
		...
		/// <returns></returns>
		public static Attribute GetCustomAttribute<T> ( this PropertyInfo pi ) where T : Attribute {
		...
		/// <param name="pi">The type.</param>
		/// <returns></returns>
		public static Attribute GetCustomAttribute<T> ( this ParameterInfo pi ) where T : Attribute {
			return GetCustomAttributes<T> ( pi ).FirstOrDefault ( );
		}
		...
		/// <returns></returns>
		public static Attribute GetCustomAttribute<T> ( this FieldInfo fi ) where T : Attribute {
